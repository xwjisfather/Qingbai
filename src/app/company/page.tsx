        ...
        <section className="bg-white/90 rounded-3xl shadow-xl px-8 py-12 md:py-16 relative overflow-hidden">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 mx-auto space-y-6">
            <motion.p 
              ...
              className="relative"
            >
              <span className="absolute -left-2 top-0 text-4xl text-[#29BB89]/10 font-serif">「</span>
              ...
              <span className="absolute -right-2 bottom-0 text-4xl text-[#29BB89]/10 font-serif">」</span>
            </motion.p>
